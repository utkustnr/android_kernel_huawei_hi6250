...
/*****************************************************************************
  6 EXTERN FUNCTION
*****************************************************************************/
extern void plat_dfr_cfg_set_etc(uint64_t arg);
extern void plat_beatTimer_timeOut_reset_cfg_set_etc(uint64_t arg);
extern int32_t bfgx_store_stack_mem_to_file_etc(void);
...
extern int32_t wifi_notice_hal_memdump_etc(void);
extern int32_t bfgx_notice_hal_memdump_etc(void);
extern int32_t bfgx_memdump_quenue_clear_etc(void);
extern void wifi_memdump_quenue_clear_etc(void);
extern int32_t bfgx_memdump_enquenue_etc(uint8_t *buf_ptr, uint16_t count);
extern int32_t wifi_memdump_enquenue_etc(uint8_t *buf_ptr, uint16_t count);
